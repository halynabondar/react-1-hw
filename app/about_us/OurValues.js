    ...
    return (
        <div className={styles.container}>
            <div className={styles.item}>
                ...
                <div>
                    <h3>Exploration</h3>
                    <p className={styles.text}>We are driven by a deep-seated desire to explore the unknown. We believe
                        that the pursuit of
            ...
            <div className={styles.item}>
                ...
                <div>
                    <h3>Innovation</h3>
                    <p className={styles.text}>At Galactica, we prioritize cutting-edge technology and innovation. We
                        are constantly
                        evolving
            ...
            <div className={styles.item}>
                ...
                <div>
                    ...
                    <p className={styles.text}>We are committed to making space exploration sustainable for future
            ...
            <div className={styles.item}>
                ...
                <div>
                    <h3>Community</h3>
                    <p className={styles.text}>We believe in the power of collective exploration. Our journeys are not
                        just about reaching
                        new
